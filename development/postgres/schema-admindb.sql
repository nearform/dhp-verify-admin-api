--- db init for Verifier admin ---
CREATE DATABASE hpassadmindb;

------ Create DDL : auto executed if table does not exist ---
...
"enum_verifier_status" AS ENUM('active', 'inactive', 'revoked');
...
DROP TYPE IF EXISTS "ver_admin"."enum_user_status"; CREATE TYPE "ver_admin"."enum_user_status" AS 
